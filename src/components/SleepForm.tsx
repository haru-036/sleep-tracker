          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`text-sm tracking-wide transition-colors ${currentRecord.hasCaffeine
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`w-10 h-10 rounded-full transition-colors flex items-center justify-center ${!currentRecord.hasCaffeine
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`w-10 h-10 rounded-full transition-colors flex items-center justify-center ${!currentRecord.hasBath
                    ? "bg-neutral-700 border border-neutral-600 text-neutral-100"
                    : "bg-neutral-850 border border-neutral-800 text-neutral-500 hover-border-neutral-700"
                  }`}
              >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`text-sm tracking-wide transition-colors ${currentRecord.hasMedication
                    ? "text-neutral-300 hover:text-neutral-100"
                    : "text-neutral-600"
                  }`}
              >
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`w-10 h-10 rounded-full transition-colors flex items-center justify-center ${!currentRecord.hasMedication
                    ? "bg-neutral-700 border border-neutral-600 text-neutral-100"
                    : "bg-neutral-850 border border-neutral-800 text-neutral-500 hover-border-neutral-700"
                  }`}
              >
